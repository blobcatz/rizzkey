...
const avatarDecorations = ref<rizzkey.entities.AdminAvatarDecorationsListResponse>([]);
...
function del(avatarDecoration) {
	os.confirm({
		...
		rizzkeyApi('admin/avatar-decorations/delete', avatarDecoration);
	});
}
...
function load() {
	rizzkeyApi('admin/avatar-decorations/list').then(_avatarDecorations => {
